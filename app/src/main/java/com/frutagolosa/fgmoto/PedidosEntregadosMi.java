...
public class PedidosEntregadosMi extends AppCompatActivity {
  ...
  int LAUNCH_4_ACTIVITY = 4;
  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    setContentView(R.layout.activity_pedidos_entregados_mi);

    setTitle("Entregados por mi");
  ...
  private void cargar(){     recyclerView = findViewById(R.id.recyclerView9);
      ...
      public void onResponse(Call<List<Contact>> call, Response<List<Contact>> response) {
        ...
        adapter.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View view) {
            ...
            Intent c= new Intent(PedidosEntregadosMi.this, DetallePedido.class);
            ...
            startActivityForResult(c,LAUNCH_4_ACTIVITY);
