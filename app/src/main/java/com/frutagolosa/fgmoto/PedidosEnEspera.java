...
public class PedidosEnEspera extends AppCompatActivity {
  ...
  private void cargare(){
    ...
    Call<List<Contact>> call = apiInterface.getContacts("https://frutagolosa.com/FrutaGolosaApp/AdmPedidosApp.php?c="+ciudad+"&e=En Espera");
      ...
      public void onResponse(Call<List<Contact>> call, Response<List<Contact>> response) {
        ...
        adapter.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View view) {
            ...
            Intent c= new Intent(PedidosEnEspera.this, DetallePedido.class);
